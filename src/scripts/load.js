...
function initNavScripts() {
  ...
  document.getElementById("copy").addEventListener("click", function () {
    ...
    navigator.clipboard
      ...
      .then(() => {
        ...
        themeIcon.src = themeIcon.src.includes("link.webp")
          ? "/resrc/images/icons/tick.webp"
          : "/resrc/images/icons/link.webp";
        setTimeout(() => {
  ...
  if (pwaBtn) {
    pwaBtn.addEventListener("click", async () => {
      ...
      if (isInstalled) {
        showAlert("PWA Installed", "You already have the app installed.", [
          { text: "OK" },
        ]);
        return;
      }
      ...
      if (deferredPrompt) {
        ...
        if (choice.outcome === "accepted") {
          ...
          showAlert("Install Cancelled", "Installation was dismissed.", [
            { text: "OK" },
          ]);
        }
      } else {
  ...
  window.addEventListener("appinstalled", () => {
    showAlert("PWA Installed", "The app has been successfully installed!", [
      { text: "OK" },
    ]);
    deferredPrompt = null;
  });
  ...
  if (pathname && pathname !== "index.html") {
    try {
      const res = await fetch(
        "https://raw.githubusercontent.com/MalangBvp/redirector/main/r/redirects.json",
      );
      ...
      showAlert("Error", "Redirection failed. Please try again later.", [
        { text: "OK" },
      ]);
    }
  }
